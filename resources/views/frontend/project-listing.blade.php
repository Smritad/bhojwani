...
<section class="page-header @@ExtraClass">
    <div class="page-header__bg" style="background-image: url('{{ asset('bhojwani/project/banner/' . $bannerProject->banner_image) }}');"></div>
    <div class="container">
            ...
            <div class="project-one__item__info">
                <div class="project-one__item__bg">
                    <h4 class="project-one__item__heading">
                        <a href="{{ url('portfolio-details/' . $project->id) }}">{{ $project->project_heading }}</a>
                    </h4>
