...
<head>
    ...
    <div class="mb-3">
        <label>Banner Image (current)</label><br>
        <img src="{{ asset('uploads/project/' . $project->banner_image) }}" width="100">
        <input type="file" name="banner_image" class="form-control mt-2">
    </div>

    <div class="mb-3">
        <label>Project Image (current)</label><br>
        <img src="{{ asset('uploads/project/' . $project->project_image) }}" width="100">
