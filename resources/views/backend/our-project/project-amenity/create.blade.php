            ...
            <div class="page-title">
              <div class="row">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Project Animity</li>
                </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-header">
                        <h4>Project Animity Details Form</h4>
...
add feild add description 

and secton 2 add image,title in section display and add more btn give to add multiple and store in db comma seperated and image preview used
