                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('projectamenity-details.create') }}" class="btn btn-primary px-5 radius-30">+ Add Project Amenities Details</a>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($amenities as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('projectamenity-details.edit', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                    <form action="{{ route('projectamenity-details.destroy', $item->id) }}" method="POST" style="display:inline-block;">
                                                        @csrf @method('DELETE')
